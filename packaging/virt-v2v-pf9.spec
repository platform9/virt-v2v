...
%install
# The build script runs make install DESTDIR and sets BUILD_STAGING.
...
%{_datadir}/virt-v2v/
%{_libdir}/virt-v2v/ 2>/dev/null ||:
%{_sysconfdir}/virt-v2v/ 2>/dev/null ||:

%changelog
* Mon Jun 16 2026 Platform9 <eng@platform9.com> - 2.11.8-1.pf9
